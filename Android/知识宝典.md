...
### 13、Requestlayout，onlayout，onDraw，DrawChild区别与联系。
...
### 19、setOnTouchListener与dispatchTouchEvent关系
...
### 31、Bitmap如何处理大图，如一张30M的大图，如何预防OOM
...
### 37、线程同步 synchronized 同步代码块 同步方法 同步锁。
...
### 43、String为什么不可变，StringBuffer可变	
...
### 62、容器（HashMap、HashSet、LinkedList、ArrayList、数组等）
