...
​	2、堆区（heap），一般由程序员分配释放， 若程序员不释放，JVM不定时观察发现没有引用指向时会GC回收 。（所有线程共享的一块内存区域）
...
6、方法区： 用于存储已被虚拟机加载的类信息、常量、静态变量、即时编译器编译后的代码等

数据。（所有线程共享的一块内存区域）

![img](C:\Users\Administrator\AppData\Local\YNote\data\qq432337FEDCB6EB5443353EB50AE37219\bd9c31e011364654b5ed809ac980f1c6\qq截图20190910172019.png)
